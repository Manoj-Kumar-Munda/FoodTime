...
const Explore = () => {
  return (
    <section className="w-full px-2 py-4 flex flex-wrap justify-between items-center my-6 bg-secondary/5">
            <div className="shrink-0 flex-grow space-y-4 basis-full lg:basis-2/5 lg:pr-6">
              <h1 className=" text-4xl lg:text-6xl font-Marienda text-primary">
